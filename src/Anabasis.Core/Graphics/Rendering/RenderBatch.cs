...
public sealed class RenderBatch : IDisposable
{
    ...
    public void DrawElements(PrimitiveType primitiveType, uint count, DrawElementsType indexType, uint indexOffset) =>
        _gl.DrawElementsI(primitiveType, count, indexType, indexOffset);
